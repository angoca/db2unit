...
:install
 ...
 if %continue% EQU 1 call:installScript %DB2UNIT_SRC_MAIN_CODE_PATH%\08-ExportTools.sql
 if %continue% EQU 1 call:installScript %DB2UNIT_SRC_MAIN_CODE_PATH%\09-Version.sql
goto:eof
