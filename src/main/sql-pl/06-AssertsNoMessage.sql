...
/**
 * Asserts if the given two XML documents are equal.
 *
 * IN EXPECTED
...
_END
  ...
  LANGUAGE SQL
  SPECIFIC P_ASSERT_XML_EQUALS
  DYNAMIC RESULT SETS 0
  MODIFIES SQL DATA
  NOT DETERMINISTIC
  NO EXTERNAL ACTION
 P_ASSERT_XML_EQUALS: BEGIN
  DECLARE RET INT;

  CALL ASSERT_XML_EQUALS(NULL, EXPECTED, ACTUAL);

  GET DIAGNOSTICS RET = DB2_RETURN_STATUS;

  RETURN RET;
 END P_ASSERT_XML_EQUALS @
...
_END
  ...
  LANGUAGE SQL
  SPECIFIC P_ASSERT_XML_NULL
  DYNAMIC RESULT SETS 0
  MODIFIES SQL DATA
  NOT DETERMINISTIC
  NO EXTERNAL ACTION
 P_ASSERT_XML_NULL: BEGIN
  DECLARE RET INT;

  CALL ASSERT_XML_NULL(NULL, DOC);

  GET DIAGNOSTICS RET = DB2_RETURN_STATUS;

  RETURN RET;
 END P_ASSERT_XML_NULL @
...
_END
  ...
  LANGUAGE SQL
  SPECIFIC P_ASSERT_XML_NOT_NULL
  DYNAMIC RESULT SETS 0
  MODIFIES SQL DATA
  NOT DETERMINISTIC
  NO EXTERNAL ACTION
 P_ASSERT_XML_NOT_NULL: BEGIN
  DECLARE RET INT;

  CALL ASSERT_XML_NOT_NULL(NULL, DOC);
