...
ALTER MODULE DB2UNIT ADD
 ...
 F_PROC_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.PROC_MESSAGE',
    LOGGER_ID);
...
ALTER MODULE DB2UNIT ADD
 ...
 P_FAIL_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.FAIL_MESSAGE',
    LOGGER_ID);
  -- Pre process
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_STRING_EQUALS_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.ASSERT_STRING_EQUALS_MESSAGE',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_STRING_NULL_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.ASSERT_STRING_NULL_MESSAGE',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_STRING_NOT_NULL_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.ASSERT_STRING_NOT_NULL_MESSAGE',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_BOOLEAN_EQUALS_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.ASSERT_BOOLEAN_EQUALS_MESSAGE',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_BOOLEAN_TRUE_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.ASSERT_BOOLEAN_TRUE_MESSAGE',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_BOOLEAN_FALSE_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.ASSERT_BOOLEAN_FALSE_MESSAGE',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_BOOLEAN_NULL_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.ASSERT_BOOLEAN_NULL_MESSAGE',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_BOOLEAN_NOT_NULL_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.ASSERT_BOOLEAN_NOT_NULL_MESSAGE',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_INT_EQUALS_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.ASSERT_INT_EQUALS_MESSAGE',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_INT_NULL_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.ASSERT_INT_NULL_MESSAGE',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_INT_NOT_NULL_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.ASSERT_INT_NOT_NULL_MESSAGE',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_DEC_EQUALS_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.ASSERT_DEC_EQUALS_MESSAGE',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_DEC_NULL_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.ASSERT_DEC_NULL_MESSAGE',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_DEC_NOT_NULL_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.ASSERT_DEC_NOT_NULL_MESSAGE',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_CHECK_COLUMN: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.CHECK_COLUMN', LOGGER_ID);
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_TABLE_EQUALS_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.ASSERT_TABLE_EQUALS',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 F_CHECK_TABLE_EMPTYNESS: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.CHECK_TABLE_EMPTYNESS',
    LOGGER_ID);
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_TABLE_EMPTY_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.ASSERT_TABLE_EMPTY',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_TABLE_NON_EMPTY_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.ASSERT_TABLE_NON_EMPTY',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_TIMESTAMP_EQUALS_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.ASSERT_TIMESTAMP_EQUALS_MESSAGE',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_TIMESTAMP_NULL_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.ASSERT_TIMESTAMP_NULL_MESSAGE',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_TIMESTAMP_NOT_NULL_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.ASSERT_TIMESTAMP_NOT_NULL_MESSAGE',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_DATE_EQUALS_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.ASSERT_DATE_EQUALS_MESSAGE',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_DATE_NULL_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.ASSERT_DATE_NULL_MESSAGE',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_DATE_NOT_NULL_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.ASSERT_DATE_NOT_NULL_MESSAGE',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_TIME_EQUALS_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.ASSERT_TIME_EQUALS_MESSAGE',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_TIME_NULL_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.ASSERT_TIME_NULL_MESSAGE',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_TIME_NOT_NULL_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.ASSERT_TIME_NOT_NULL_MESSAGE',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
