...
ALTER MODULE DB2UNIT ADD
 ...
 P_FAIL_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.P_FAIL_MESSAGE',
    LOGGER_ID);
  -- Pre process
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_STRING_EQUALS_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.P_ASSERT_STRING_EQUALS_MESSAGE',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_STRING_NULL_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.P_ASSERT_STRING_NULL_MESSAGE',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_STRING_NOT_NULL_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.P_ASSERT_STRING_NOT_NULL_MESSAGE',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_BOOLEAN_EQUALS_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.P_ASSERT_BOOLEAN_EQUALS_MESSAGE',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_BOOLEAN_TRUE_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.P_ASSERT_BOOLEAN_TRUE_MESSAGE',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_BOOLEAN_FALSE_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.P_ASSERT_BOOLEAN_FALSE_MESSAGE',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_BOOLEAN_NULL_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.P_ASSERT_BOOLEAN_NULL_MESSAGE',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_BOOLEAN_NOT_NULL_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.P_ASSERT_BOOLEAN_NOT_NULL_MESSAGE',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_INT_EQUALS_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.P_ASSERT_INT_EQUALS_MESSAGE',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_INT_NULL_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.P_ASSERT_INT_NULL_MESSAGE',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_INT_NOT_NULL_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.P_ASSERT_INT_NOT_NULL_MESSAGE',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_DEC_EQUALS_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.P_ASSERT_DEC_EQUALS_MESSAGE',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_DEC_NULL_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.P_ASSERT_DEC_NULL_MESSAGE',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_DEC_NOT_NULL_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.P_ASSERT_DEC_NOT_NULL_MESSAGE',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_TABLE_EMPTY_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.P_ASSERT_TABLE_EMPTY',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
...
ALTER MODULE DB2UNIT ADD
 ...
 P_ASSERT_TABLE_NON_EMPTY_MESSAGE: BEGIN
  ...
  CALL LOGGER.GET_LOGGER('DB2UNIT_1B.DB2UNIT.P_ASSERT_TABLE_NON_EMPTY',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  SET RET = 0;
