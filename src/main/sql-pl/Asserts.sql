...
ALTER MODULE DB2UNIT ADD
  ...
  LANGUAGE SQL
  SPECIFIC P_ASSERT_NOT_NULL_MESSAGE
  DYNAMIC RESULT SETS 0
  MODIFIES SQL DATA
  NOT DETERMINISTIC
  NO EXTERNAL ACTION
  PARAMETER CCSID UNICODE
 P_ASSERT_NOT_NULL_MESSAGE: BEGIN
  DECLARE LOGGER_ID SMALLINT;

  CALL LOGGER.GET_LOGGER('DB2UNIT_1A.DB2UNIT.P_ASSERT_NOT_NULL_MESSAGE',
    LOGGER_ID);
  -- Pre process
  SET MESSAGE = PROC_MESSAGE(MESSAGE);
  CALL LOGGER.DEBUG(LOGGER_ID, MESSAGE);
