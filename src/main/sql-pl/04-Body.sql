 ...
 */
ALTER MODULE DB2UNIT ADD
  VARIABLE UNSTARTED ANCHOR REPORT_TESTS.FINAL_STATE CONSTANT 'Unstarted' @
 ...
 P_EXECUTION: BEGIN
  ...
  IF (CONT_BEFORE_ALL = TRUE) THEN
   ...
   WHILE (INDEX <= CARD_PROCS) DO
    ...
    ELSEIF (TEST_RESULT = UNSTARTED) THEN
...
ALTER MODULE DB2UNIT ADD
 ...
 P_CREATE_TAP_REPORT: BEGIN
  ...
  INSERT INTO TAP_REPORT (NUMBER, MESSAGE) VALUES
    ( 1, 'TAP version 13'),
    ( 2, '1..' || TOTAL);
  SET INDEX = 3;
  ...
  WHILE (AT_END = FALSE) DO
   INSERT INTO TAP_REPORT (NUMBER, MESSAGE)
     VALUES (INDEX, STATUS || ' ' || POSITION || ' ' || MESSAGE);
