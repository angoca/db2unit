...
ALTER MODULE DB2UNIT ADD
 ...
 P_REGISTER_SUITE: BEGIN
  ...
  INSERT INTO DB2UNIT_2_BETA.SUITES (SUITE_NAME) VALUES (SCHEMA_NAME);
...
ALTER MODULE DB2UNIT ADD
 ...
 P_GET_LAST_EXECUTION_ORDER: BEGIN
  ...
  DECLARE LAST_EXEC_ID ANCHOR EXECUTIONS.EXECUTION_ID;
  DECLARE STMT STATEMENT;
  DECLARE ORDER_CURSOR CURSOR
    WITH RETURN TO CLIENT
    FOR ORDER_RS;

  SET LAST_EXEC_ID = GET_LAST_EXEC_ID();
  IF (LAST_EXEC_ID IS NULL OR LAST_SCHEMA IS NULL OR LAST_SCHEMA = '') THEN
   SIGNAL SQLSTATE VALUE 'LG0P2'
