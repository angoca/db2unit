...
_END
  ...
  -- TODO The error is after the following insert
  INSERT INTO DB2UNIT_ASSERTIONS_XML.REPORT_TESTS
    (DATE, EXECUTION_ID, TEST_NAME, MESSAGE) VALUES (CURRENT TIMESTAMP,
    DB2UNIT.GET_CURRENT_EXEC_ID(), DB2UNIT.GET_CURRENT_TEST_SUITE_NAME(),
    '>>>FLAG1');
  ...
  -- TODO the xml_to_char function does not work.
  -- Error: SQLCode -1354, SQLState 560CE
  INSERT INTO DB2UNIT_ASSERTIONS_XML.REPORT_TESTS
    (DATE, EXECUTION_ID, TEST_NAME, MESSAGE) VALUES (CURRENT TIMESTAMP,
    DB2UNIT.GET_CURRENT_EXEC_ID(), DB2UNIT.GET_CURRENT_TEST_SUITE_NAME(),
    '>>>FLAG2');
