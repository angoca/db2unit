...
CREATE OR REPLACE PROCEDURE TEST_15()
 BEGIN
  ...
  CALL DB2UNIT_1B.DB2UNIT.RUN_SUITE(SCHEMA_NAME, PROC_NAME => 'Test_15');
...
CREATE OR REPLACE PROCEDURE TEST_16()
 BEGIN
  ...
  PREPARE STMT FROM SENTENCE;
  EXECUTE STMT;
  CALL DB2UNIT_1B.DB2UNIT.RUN_SUITE(SCHEMA_NAME, PROC_NAME => 'Test_16');
...
CREATE OR REPLACE PROCEDURE TEST_17()
 BEGIN
  ...
  PREPARE STMT FROM SENTENCE;
  EXECUTE STMT;
  CALL DB2UNIT_1B.DB2UNIT.RUN_SUITE(SCHEMA_NAME, PROC_NAME => 'Test_17');
  GET DIAGNOSTICS ACTUAL_RET = DB2_RETURN_STATUS;
...
CREATE OR REPLACE PROCEDURE TEST_18()
 BEGIN
  ...
  PREPARE STMT FROM SENTENCE;
  EXECUTE STMT;
  CALL DB2UNIT_1B.DB2UNIT.RUN_SUITE(SCHEMA_NAME, PROC_NAME => 'Test_18');
  GET DIAGNOSTICS ACTUAL_RET = DB2_RETURN_STATUS;
...
CREATE OR REPLACE PROCEDURE TEST_20()
 BEGIN
  ...
  CALL DB2UNIT_1B.DB2UNIT.RUN_SUITE(SCHEMA_NAME, PROC_NAME => 'Test_20');
  GET DIAGNOSTICS ACTUAL_RET = DB2_RETURN_STATUS;
...
CREATE OR REPLACE PROCEDURE TEST_21()
 BEGIN
  ...
  CALL DB2UNIT_1B.DB2UNIT.RUN_SUITE(SCHEMA_NAME, 123, 'Test_21');
  GET DIAGNOSTICS ACTUAL_RET = DB2_RETURN_STATUS;
