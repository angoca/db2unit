...
SET PATH = "SYSIBM","SYSFUN","SYSPROC","SYSIBMADM", DB2UNIT_1, TEST_DB2UNIT_EXECUTION @
...
CALL SYSPROC.ADMIN_DROP_SCHEMA('TEST_DB2UNIT_EXECUTION_TEST_15', NULL, 
  'ERRORSCHEMA', 'ERRORTABLE_15') @
CALL SYSPROC.ADMIN_DROP_SCHEMA('TEST_DB2UNIT_EXECUTION_TEST_16', NULL, 
  'ERRORSCHEMA', 'ERRORTABLE_16') @
CALL SYSPROC.ADMIN_DROP_SCHEMA('TEST_DB2UNIT_EXECUTION_TEST_17', NULL, 
  'ERRORSCHEMA', 'ERRORTABLE_17') @
CALL SYSPROC.ADMIN_DROP_SCHEMA('TEST_DB2UNIT_EXECUTION_TEST_18', NULL, 
  'ERRORSCHEMA', 'ERRORTABLE_18') @
-- 19
CALL SYSPROC.ADMIN_DROP_SCHEMA('TEST_DB2UNIT_EXECUTION_TEST_20', NULL, 
  'ERRORSCHEMA', 'ERRORTABLE_20') @
CALL SYSPROC.ADMIN_DROP_SCHEMA('TEST_DB2UNIT_EXECUTION_TEST_21', NULL, 
...
CREATE OR REPLACE PROCEDURE ONE_TIME_TEAR_DOWN()
 BEGIN
  ...
  CALL DROP_SCHEMA_TABLE('TEST_DB2UNIT_EXECUTION_TEST_15');
  CALL DROP_SCHEMA_TABLE('TEST_DB2UNIT_EXECUTION_TEST_16');
  CALL DROP_SCHEMA_TABLE('TEST_DB2UNIT_EXECUTION_TEST_17');
  CALL DROP_SCHEMA_TABLE('TEST_DB2UNIT_EXECUTION_TEST_18');
  -- 19
  CALL DROP_SCHEMA_TABLE('TEST_DB2UNIT_EXECUTION_TEST_20');
  CALL DROP_SCHEMA_TABLE('TEST_DB2UNIT_EXECUTION_TEST_21');
 END @
...
CREATE OR REPLACE PROCEDURE ONE_TIME_SETUP()
 BEGIN
  ...
  CALL CREATE_SCHEMA_TABLE('TEST_DB2UNIT_EXECUTION_TEST_15');
  CALL CREATE_SCHEMA_TABLE('TEST_DB2UNIT_EXECUTION_TEST_16');
  CALL CREATE_SCHEMA_TABLE('TEST_DB2UNIT_EXECUTION_TEST_17');
  CALL CREATE_SCHEMA_TABLE('TEST_DB2UNIT_EXECUTION_TEST_18');
  -- 19
  CALL CREATE_SCHEMA_TABLE('TEST_DB2UNIT_EXECUTION_TEST_20');
  CALL CREATE_SCHEMA_TABLE('TEST_DB2UNIT_EXECUTION_TEST_21');
 END @

-- Test the execution of a non-existent schema.
CREATE OR REPLACE PROCEDURE TEST_01()
 BEGIN
  DECLARE ACTUAL_MSG ANCHOR DB2UNIT_1.EXECUTION_REPORTS.MESSAGE_REPORT;
  DECLARE EXPECTED_MSG ANCHOR DB2UNIT_1.EXECUTION_REPORTS.MESSAGE_REPORT;
  ...
  CALL DB2UNIT_1.DB2UNIT.RUN_SUITE(SCHEMA_NAME);
  COMMIT;
  SELECT MESSAGE_REPORT INTO ACTUAL_MSG
    FROM DB2UNIT_1.EXECUTION_REPORTS
    WHERE DATE = (SELECT MAX(DATE) FROM DB2UNIT_1.EXECUTION_REPORTS);
  ...
  CALL DB2UNIT_1.DB2UNIT.ASSERT_STRING_EQUALS(EXPECTED_MSG, ACTUAL_MSG);
 END@
...
CREATE OR REPLACE PROCEDURE TEST_11()
 BEGIN
  ...
  DECLARE ACTUAL_MSG ANCHOR DB2UNIT_1.REPORT_TESTS.MESSAGE;
  DECLARE EXPECTED_MSG ANCHOR DB2UNIT_1.REPORT_TESTS.MESSAGE;
  DECLARE ACTUAL_MSG2 ANCHOR DB2UNIT_1.REPORT_TESTS.MESSAGE;
  DECLARE EXPECTED_MSG2 ANCHOR DB2UNIT_1.REPORT_TESTS.MESSAGE;
  DECLARE SCHEMA_NAME ANCHOR SYSCAT.SCHEMATA.SCHEMANAME;
  DECLARE SENTENCE ANCHOR DB2UNIT_1.MAX_VALUES.SENTENCE;
  DECLARE SQLSTT VARCHAR(5);
  DECLARE STMT STATEMENT;
  ...
  CALL DB2UNIT_1.DB2UNIT.ASSERT_STRING_EQUALS(EXPECTED_MSG, ACTUAL_MSG);
  CALL DB2UNIT_1.DB2UNIT.ASSERT_STRING_EQUALS(EXPECTED_MSG2, ACTUAL_MSG2);
 END @
...
CREATE OR REPLACE PROCEDURE TEST_12()
 BEGIN
  ...
  PREPARE STMT FROM SENTENCE;
  EXECUTE STMT;
  CALL DB2UNIT_1.DB2UNIT.RUN_SUITE(SCHEMA_NAME, PROC_NAME => 'TEST_12b');
...
CREATE OR REPLACE PROCEDURE TEST_13()
 BEGIN
  ...
  PREPARE STMT FROM SENTENCE;
  EXECUTE STMT;
  CALL DB2UNIT_1.DB2UNIT.RUN_SUITE(SCHEMA_NAME, PROC_NAME => 'Test_13a');
...
CREATE OR REPLACE PROCEDURE TEST_14()
 BEGIN
  ...
  CALL DB2UNIT_1.DB2UNIT.RUN_SUITE(SCHEMA_NAME, 5, 'Test_14');
...
CREATE OR REPLACE PROCEDURE TEST_15()
 BEGIN
  ...
  SET SCHEMA_NAME = 'TEST_DB2UNIT_EXECUTION_TEST_15';
  ...
  CALL DB2UNIT_1.DB2UNIT.RUN_SUITE(SCHEMA_NAME, PROC_NAME => 'Test_15');
...
CREATE OR REPLACE PROCEDURE TEST_16()
 BEGIN
  ...
  SET SCHEMA_NAME = 'TEST_DB2UNIT_EXECUTION_TEST_16';
  SET EXPECTED_RET = 0;
  ...
  PREPARE STMT FROM SENTENCE;
  EXECUTE STMT;
  CALL DB2UNIT_1.DB2UNIT.RUN_SUITE(SCHEMA_NAME, PROC_NAME => 'Test_16');
...
CREATE OR REPLACE PROCEDURE TEST_17()
 BEGIN
  ...
  SET SCHEMA_NAME = 'TEST_DB2UNIT_EXECUTION_TEST_17';
  SET EXPECTED_RET = 1;
  ...
  PREPARE STMT FROM SENTENCE;
  EXECUTE STMT;
  CALL DB2UNIT_1.DB2UNIT.RUN_SUITE(SCHEMA_NAME, PROC_NAME => 'Test_17');
  GET DIAGNOSTICS ACTUAL_RET = DB2_RETURN_STATUS;
...
CREATE OR REPLACE PROCEDURE TEST_18()
 BEGIN
  ...
  SET SCHEMA_NAME = 'TEST_DB2UNIT_EXECUTION_TEST_18';
  SET EXPECTED_RET = 1;
  ...
  PREPARE STMT FROM SENTENCE;
  EXECUTE STMT;
  CALL DB2UNIT_1.DB2UNIT.RUN_SUITE(SCHEMA_NAME, PROC_NAME => 'Test_18');
  GET DIAGNOSTICS ACTUAL_RET = DB2_RETURN_STATUS;
...
CREATE OR REPLACE PROCEDURE TEST_19()
 BEGIN
  ...
  SET SCHEMA_NAME = 'TEST_DB2UNIT_EXECUTION_TEST_19';
  SET EXPECTED_RET = 2;
...
CREATE OR REPLACE PROCEDURE TEST_20()
 BEGIN
  ...
  SET SCHEMA_NAME = 'TEST_DB2UNIT_EXECUTION_TEST_20';
  SET EXPECTED_RET = 2;

  CALL DB2UNIT_1.DB2UNIT.RUN_SUITE(SCHEMA_NAME, PROC_NAME => 'Test_20');
  GET DIAGNOSTICS ACTUAL_RET = DB2_RETURN_STATUS;
...
CREATE OR REPLACE PROCEDURE TEST_21()
 BEGIN
  ...
  SET SCHEMA_NAME = 'TEST_DB2UNIT_EXECUTION_TEST_21';
  SET EXPECTED_RET = 2;

  CALL DB2UNIT_1.DB2UNIT.RUN_SUITE(SCHEMA_NAME, 123, 'Test_21');
  GET DIAGNOSTICS ACTUAL_RET = DB2_RETURN_STATUS;
