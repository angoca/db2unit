...
SET CURRENT SCHEMA DB2UNIT_ASSERTIONS @

SET PATH = "SYSIBM","SYSFUN","SYSPROC","SYSIBMADM", DB2UNIT_1, DB2UNIT_ASSERTIONS @
...
CREATE TABLE REPORT_TESTS LIKE DB2UNIT_1.REPORT_TESTS @

ALTER TABLE DB2UNIT_ASSERTIONS.REPORT_TESTS
  ALTER COLUMN SUITE_NAME
  SET WITH DEFAULT 'DB2UNIT_ASSERTIONS' @
...
CREATE OR REPLACE PROCEDURE ONE_TIME_SETUP()
 BEGIN
  ...
  SET SENTENCE = 'DROP TABLE ' || DB2UNIT_1.DB2UNIT.UTILITY_SCHEMA
    || '.TABLE_TEST_01';
...
CREATE OR REPLACE PROCEDURE TEST_GENERAL_01()
 BEGIN
  ...
  SELECT MESSAGE INTO ACTUAL_MSG
    FROM DB2UNIT_ASSERTIONS.REPORT_TESTS
    WHERE DATE = (SELECT MAX(DATE) FROM DB2UNIT_ASSERTIONS.REPORT_TESTS);
...
CREATE OR REPLACE PROCEDURE TEST_STRING_01()
 BEGIN
  ...
  INSERT INTO DB2UNIT_ASSERTIONS.REPORT_TESTS (DATE, EXECUTION_ID,
...
CREATE OR REPLACE PROCEDURE TEST_TABLE_01()
 BEGIN
  ...
  SET SENTENCE = 'CREATE TABLE ' || DB2UNIT_1.DB2UNIT.UTILITY_SCHEMA || '.'
    || TABLE_NAME || '(COL int)';
  PREPARE STMT FROM SENTENCE;
  EXECUTE STMT;

  CALL DB2UNIT.ASSERT_TABLE_EMPTY(DB2UNIT_1.DB2UNIT.UTILITY_SCHEMA,
    TABLE_NAME);
  CALL DB2UNIT.CLEAN_TEST_RESULT();
...
CREATE OR REPLACE PROCEDURE TEST_TABLE_02()
 BEGIN
  ...
  PREPARE STMT FROM SENTENCE;
  EXECUTE STMT;
  SET SENTENCE = 'INSERT INTO ' || DB2UNIT_1.DB2UNIT.UTILITY_SCHEMA || '.'
    || TABLE_NAME || ' VALUES (1)';
  PREPARE STMT FROM SENTENCE;
  EXECUTE STMT;
...
CREATE OR REPLACE PROCEDURE TEST_TABLE_03()
 BEGIN
  ...
  SET EXPECTED_MSG = 'Table does not exist '
    || DB2UNIT_1.DB2UNIT.UTILITY_SCHEMA || '.' || TABLE_NAME;
...
CREATE OR REPLACE PROCEDURE TEST_TABLE_04()
 BEGIN
  ...
  CALL DB2UNIT.ASSERT_TABLE_NON_EMPTY(DB2UNIT_1.DB2UNIT.UTILITY_SCHEMA,
    TABLE_NAME);
  CALL DB2UNIT.CLEAN_TEST_RESULT();
...
CREATE OR REPLACE PROCEDURE TEST_TABLE_07()
 BEGIN
  ...
  SET EXPECTED_MSG = 'Some of the entry values are null: '
    || DB2UNIT_1.DB2UNIT.UTILITY_SCHEMA || ',' || TABLE_NAME || ','
    || DB2UNIT_1.DB2UNIT.UTILITY_SCHEMA || ',NULL';
  INSERT INTO DB2UNIT_ASSERTIONS.REPORT_TESTS (DATE, EXECUTION_ID,
    TEST_NAME, MESSAGE) VALUES (CURRENT TIMESTAMP, 0, '', EXPECTED_MSG);
  SET SENTENCE = 'CREATE TABLE ' || DB2UNIT_1.DB2UNIT.UTILITY_SCHEMA || '.'
    || TABLE_NAME || '(COL int)';
  ...
  CALL DB2UNIT.ASSERT_TABLE_EQUALS(DB2UNIT_1.DB2UNIT.UTILITY_SCHEMA,
    TABLE_NAME, DB2UNIT_1.DB2UNIT.UTILITY_SCHEMA, NULL);
  CALL DB2UNIT.CLEAN_TEST_RESULT();
...
CREATE OR REPLACE PROCEDURE TEST_TABLE_08()
 BEGIN
  ...
  SET EXPECTED_MSG = 'Some of the entry values are null: '
    || DB2UNIT_1.DB2UNIT.UTILITY_SCHEMA || ',' || TABLE_NAME || ',NULL,'
    || TABLE_NAME;
  INSERT INTO DB2UNIT_ASSERTIONS.REPORT_TESTS (DATE, EXECUTION_ID,
    TEST_NAME, MESSAGE) VALUES (CURRENT TIMESTAMP, 0, '', EXPECTED_MSG);
  SET SENTENCE = 'CREATE TABLE ' || DB2UNIT_1.DB2UNIT.UTILITY_SCHEMA || '.'
...
CREATE OR REPLACE PROCEDURE TEST_TABLE_09()
 BEGIN
  ...
  CALL DB2UNIT.ASSERT_TABLE_EQUALS(DB2UNIT_1.DB2UNIT.UTILITY_SCHEMA,
    NULL, DB2UNIT_1.DB2UNIT.UTILITY_SCHEMA, TABLE_NAME);
  CALL DB2UNIT.CLEAN_TEST_RESULT();
...
CREATE OR REPLACE PROCEDURE TEST_TABLE_11()
 BEGIN
  ...
  CALL DB2UNIT.ASSERT_TABLE_EQUALS(DB2UNIT_1.DB2UNIT.UTILITY_SCHEMA,
    TABLE_NAME_EXP, DB2UNIT_1.DB2UNIT.UTILITY_SCHEMA, TABLE_NAME_ACT);
  CALL DB2UNIT.CLEAN_TEST_RESULT();
