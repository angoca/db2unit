...
SET PATH = "SYSIBM","SYSFUN","SYSPROC","SYSIBMADM", DB2UNIT_1, DB2UNIT_EXECUTION @
...
CREATE OR REPLACE PROCEDURE TEST_02()
 BEGIN
  ...
  SET SENTENCE = 'DELETE FROM ' || SCHEMA_NAME || '.REPORT_TESTS '
    ...
    || 'AND MESSAGE = ''0 unexecuted tests''';
...
CREATE OR REPLACE PROCEDURE TEST_07()
 BEGIN
  ...
  SET SCHEMA_NAME = 'DB2UNIT_EXECUTION_TEST_7';
  ...
  SET SENTENCE = 'DELETE FROM ' || SCHEMA_NAME || '.REPORT_TESTS '
    || 'WHERE DATE = (SELECT MAX(DATE) '
    || 'FROM ' || SCHEMA_NAME || '.REPORT_TESTS) '
    || 'AND MESSAGE LIKE ''_ unexecuted tests''';
  CALL LOGGER.ERROR(MESSAGE => SENTENCE);
  PREPARE STMT FROM SENTENCE;
  EXECUTE STMT;
  SET SENTENCE = 'DELETE FROM ' || SCHEMA_NAME || '.REPORT_TESTS '
...
CREATE OR REPLACE PROCEDURE TEST_10()
 BEGIN
  ...
  SET SENTENCE = 'DELETE FROM ' || SCHEMA_NAME || '.REPORT_TESTS '
    || 'WHERE DATE = (SELECT MAX(DATE) '
    || 'FROM ' || SCHEMA_NAME || '.REPORT_TESTS) '
    || 'AND MESSAGE LIKE ''% unexecuted tests''';
  CALL LOGGER.ERROR(MESSAGE => SENTENCE);
  PREPARE STMT FROM SENTENCE;
  EXECUTE STMT;
  SET SENTENCE = 'DELETE FROM ' || SCHEMA_NAME || '.REPORT_TESTS '
...
CREATE OR REPLACE PROCEDURE TEST_12()
 BEGIN
  ...
  PREPARE STMT FROM SENTENCE;
  EXECUTE STMT;
  CALL DB2UNIT_1.DB2UNIT.RUN_SUITE(SCHEMA_NAME, TEST_NAME => 'TEST_12b');
...
CREATE OR REPLACE PROCEDURE TEST_13()
 BEGIN
  ...
  PREPARE STMT FROM SENTENCE;
  EXECUTE STMT;
  CALL DB2UNIT_1.DB2UNIT.RUN_SUITE(SCHEMA_NAME, TEST_NAME => 'Test_13a');
...
CREATE OR REPLACE PROCEDURE TEST_15()
 BEGIN
  ...
  CALL DB2UNIT_1.DB2UNIT.RUN_SUITE(SCHEMA_NAME, TEST_NAME => 'Test_15');
...
CREATE OR REPLACE PROCEDURE TEST_16()
 BEGIN
  ...
  PREPARE STMT FROM SENTENCE;
  EXECUTE STMT;
  CALL DB2UNIT_1.DB2UNIT.RUN_SUITE(SCHEMA_NAME, TEST_NAME => 'Test_16');
...
CREATE OR REPLACE PROCEDURE TEST_17()
 BEGIN
  ...
  PREPARE STMT FROM SENTENCE;
  EXECUTE STMT;
  CALL DB2UNIT_1.DB2UNIT.RUN_SUITE(SCHEMA_NAME, TEST_NAME => 'Test_17');
  GET DIAGNOSTICS ACTUAL_RET = DB2_RETURN_STATUS;
...
CREATE OR REPLACE PROCEDURE TEST_18()
 BEGIN
  ...
  PREPARE STMT FROM SENTENCE;
  EXECUTE STMT;
  CALL DB2UNIT_1.DB2UNIT.RUN_SUITE(SCHEMA_NAME, TEST_NAME => 'Test_18');
  GET DIAGNOSTICS ACTUAL_RET = DB2_RETURN_STATUS;
...
CREATE OR REPLACE PROCEDURE TEST_20()
 BEGIN
  ...
  CALL DB2UNIT_1.DB2UNIT.RUN_SUITE(SCHEMA_NAME, TEST_NAME => 'Test_20');
  GET DIAGNOSTICS ACTUAL_RET = DB2_RETURN_STATUS;
...
CREATE OR REPLACE PROCEDURE TEST_22()
 BEGIN
  DECLARE ACTUAL_MSG1 ANCHOR DB2UNIT_1.REPORT_TESTS.MESSAGE;
  DECLARE EXPECTED_MSG1 ANCHOR DB2UNIT_1.REPORT_TESTS.MESSAGE;
  DECLARE ACTUAL_MSG2 ANCHOR DB2UNIT_1.REPORT_TESTS.MESSAGE;
  DECLARE EXPECTED_MSG2 ANCHOR DB2UNIT_1.REPORT_TESTS.MESSAGE;
  DECLARE SCHEMA_NAME ANCHOR SYSCAT.SCHEMATA.SCHEMANAME;
  DECLARE SENTENCE ANCHOR DB2UNIT_1.MAX_VALUES.SENTENCE;
  ...
  SET SENTENCE = 'SELECT MESSAGE '
    ...
    || 'WHERE EXECUTION_ID = ( '
    || ' SELECT EXECUTION_ID '
    || ' FROM DB2UNIT_1.EXECUTIONS E '
    || ' WHERE  DATE = ( '
    || '  SELECT MAX(DATE) '
    || '  FROM DB2UNIT_1.SUITES_EXECUTIONS SE JOIN DB2UNIT_1.EXECUTIONS E2 '
  ...
  CALL DB2UNIT_1.DB2UNIT.RUN_SUITE(SCHEMA_NAME, TEST_NAME => 'TEST_22b');
  SET SENTENCE = 'SELECT MESSAGE '
    || 'FROM DB2UNIT_EXECUTION_TEST_22.REPORT_TESTS '
    || 'WHERE EXECUTION_ID = ( '
    || ' SELECT EXECUTION_ID '
  ...
  CALL DB2UNIT_1.DB2UNIT.ASSERT_STRING_EQUALS(EXPECTED_MSG1, ACTUAL_MSG1);
  CALL DB2UNIT_1.DB2UNIT.ASSERT_STRING_EQUALS(EXPECTED_MSG2, ACTUAL_MSG2);
 END @
...
CREATE OR REPLACE PROCEDURE TEST_23()
 BEGIN
  DECLARE EXEC_1 ANCHOR DB2UNIT_1.EXECUTION_REPORTS.EXECUTION_ID;
  DECLARE EXEC_2 ANCHOR DB2UNIT_1.EXECUTION_REPORTS.EXECUTION_ID;
  DECLARE EXEC_3 ANCHOR DB2UNIT_1.EXECUTION_REPORTS.EXECUTION_ID;
